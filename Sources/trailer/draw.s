...
; unsigned char* psrc  -> tmp0
; unsigned char* pdst  -> tmp1
; unsigned char width  -> _W
; unsigned char height -> _H
; a/x -> pointer on description
_CopyRectangle
.(	
	sta tmp0+0
	stx tmp0+1
