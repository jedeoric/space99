...
void PrepareCosTable()
{
	...
	do
	{
		value=CosTable[angle];
		value=(value*6)/256;
		CosTable[angle]=(unsigned char)value;
		angle++;
	}
	while (angle);
}
...
_LabelPicture1		= _BufferUnpack+2010*1
_LabelPicture2		= _BufferUnpack+2010*2
_LabelPicture3		= _BufferUnpack+2010*3
_LabelPicture4		= _BufferUnpack+2010*4
_LabelPicture5		= _BufferUnpack+2010*5
